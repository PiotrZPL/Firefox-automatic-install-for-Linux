#!/bin/bash  
echo
echo "Please wait. I am downloading the latest version of Firefox ESR"  
echo
wget -O FirefoxESR32.tar.bz2 "https://download.mozilla.org/?product=firefox-esr-latest-ssl&os=linux"
echo
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/opt/firefox-esr-32bit/firefox/firefox --private-window %u --class FirefoxESR32" > Firefox-ESR.desktop
echo -n
...
sudo cp Firefox-ESR.desktop /etc/skel/Desktop
echo "Cleaning up after myself"
rm FirefoxESR32.tar.bz2
