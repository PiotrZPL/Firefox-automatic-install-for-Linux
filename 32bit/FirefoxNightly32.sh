...
echo
wget -O FirefoxNightly32.tar.bz2 "https://download.mozilla.org/?product=firefox-nightly-latest-ssl&os=linux"
echo
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/opt/firefox-nightly-32bit/firefox/firefox --private-window %u --class FirefoxNightly32" > Firefox-Nightly.desktop
echo -n
