...
echo
wget -O FirefoxBeta32.tar.bz2 "https://download.mozilla.org/?product=firefox-beta-latest-ssl&os=linux"
echo
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/opt/firefox-beta-32bit/firefox/firefox --private-window %u --class FirefoxBeta32" > Firefox-Beta.desktop
echo -n
