...
echo
wget -O FirefoxDeveloperEdition32.tar.bz2 "https://download.mozilla.org/?product=firefox-devedition-latest-ssl&os=linux"
echo
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/opt/firefox-developer-edition-32bit/firefox/firefox --private-window %u --class FirefoxDeveloperEdition32" > Firefox-Developer-Edition.desktop
echo -n
...
rm FirefoxDeveloperEdition32.tar.bz2
