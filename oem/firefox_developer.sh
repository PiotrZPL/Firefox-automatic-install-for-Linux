#!/bin/sh
#
# Firefox Automatic Install for Linux - Firefox Developer Edition - oem - silent install
#
...
mkdir /opt/Mozilla/Mozilla_Firefox_Developer_Edition

# Extracts to the install path.
tar xjf "$file" -C /opt/Mozilla/Mozilla_Firefox_Developer_Edition/

# Required permissions needed for Mozilla Firefox automatic update feature to work.
chmod -R 757 /opt/Mozilla/Mozilla_Firefox_Developer_Edition/firefox/
...
Exec=/opt/Mozilla/Mozilla_Firefox_Developer_Edition/firefox/firefox %%u --class FirefoxDeveloperEdition
Icon=/opt/Mozilla/Mozilla_Firefox_Developer_Edition/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Exec=/opt/Mozilla/Mozilla_Firefox_Developer_Edition/firefox/firefox --new-window %%u --class FirefoxDeveloperEdition
Name=New Window
...
Exec=/opt/Mozilla/Mozilla_Firefox_Developer_Edition/firefox/firefox --private-window %%u --class FirefoxDeveloperEdition
...
cp Mozilla_Firefox_Developer_Edition.desktop /usr/share/applications 2>/dev/null || true
...
sudo find /home/*/"$DESKTOP_NAME" -maxdepth 1 -type d -exec cp Mozilla_Firefox_Developer_Edition.desktop '{}' \; -exec chown --reference='{}' '{}/Mozilla_Firefox_Developer_Edition.desktop' \;

# Adds a desktop icon to all future new login users.
mkdir -p /etc/skel/Desktop
cp Mozilla_Firefox_Developer_Edition.desktop /etc/skel/Desktop
