#!/bin/sh
#
# Firefox Automatic Install for Lnux  - Firefox (current stable edition) - oem - silent install
...
mkdir /opt/Mozilla/Mozilla_Firefox

# Extracts to the install path.
tar xjf "$file" -C /opt/Mozilla/Mozilla_Firefox/

# Required permissions needed for Mozilla Firefox automatic update feature to work.
chmod -R 757 /opt/Mozilla/Mozilla_Firefox/firefox/
...
Exec=/opt/Mozilla/Mozilla_Firefox/firefox/firefox  %%u --class MozillaFirefox
Icon=/opt/Mozilla/Mozilla_Firefox/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Exec=/opt/Mozilla/Mozilla_Firefox/firefox/firefox --new-window %%u --class MozillaFirefox
Name=New Window
...
Exec=/opt/Mozilla/Mozilla_Firefox/firefox/firefox --private-window %%u --class MozillaFirefox
...
cp Mozilla_Firefox.desktop /usr/share/applications 2>/dev/null || true
...
find /home/*/"$DESKTOP_NAME" -maxdepth 1 -type d -exec cp Mozilla_Firefox.desktop '{}' \; -exec chown --reference='{}' '{}/Mozilla_Firefox.desktop' \;

# Adds a desktop icon to all future new login users.
mkdir -p /etc/skel/Desktop
cp Mozilla_Firefox.desktop /etc/skel/Desktop
