#!/bin/sh
#
# Firefox Automatic Install for Linux - Firefox ESR (Extended Support Release) - oem - silent install 
...
display_error_message() {
  printf -- '\n%s\n' "" "" "" "Oops, something went wrong!" \
    "I apologize, but I couldn't download Firefox Extended Support Release from Mozilla." \
...
url="https://download.mozilla.org/?product=firefox-esr-latest-ssl&os=linux64"
file="FirefoxESR.tar.bz2"
...
mkdir /opt/Mozilla/Mozilla_Firefox_Extended_Support_Release

# Extracts to the install path.
tar xjf "$file" -C /opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/

# Required permissions needed for Mozilla Firefox automatic update feature to work.
chmod -R 757 /opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/firefox/
...
Exec=/opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/firefox/firefox %%u --class FirefoxESR
Icon=/opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Exec=/opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/firefox/firefox --new-window %%u --class FirefoxESR
Name=New Window
...
Exec=/opt/Mozilla/Mozilla_Firefox_Extended_Support_Release/firefox/firefox --private-window %%u --class FirefoxESR
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗 " > Mozilla_Firefox_Extended_Support_Release.desktop ;
...
chmod +x Mozilla_Firefox_Extended_Support_Release.desktop
...
cp Mozilla_Firefox_Extended_Support_Release.desktop  /usr/share/applications 2>/dev/null || true
...
find /home/*/"$DESKTOP_NAME" -maxdepth 1 -type d -exec cp Mozilla_Firefox_Extended_Support_Release.desktop  '{}' \; -exec chown --reference='{}' '{}/Mozilla_Firefox_Extended_Support_Release.desktop ' \;

# Adds a desktop icon to all future new login users.
mkdir -p /etc/skel/Desktop
cp Mozilla_Firefox_Extended_Support_Release.desktop  /etc/skel/Desktop

# Removes the temporary files no longer needed.
rm "$file"
rm Mozilla_Firefox_Extended_Support_Release.desktop
