#!/bin/sh
#
# Firefox Automatic Install for Linux - Firefox Beta - oem - silent install
#
...
mkdir /opt/Mozilla/Mozilla_Firefox_Beta

# Extracts to the install path.
tar xjf "$file" -C /opt/Mozilla/Mozilla_Firefox_Beta/

# Required permissions needed for Mozilla Firefox automatic update feature to work.
chmod -R 757 /opt/Mozilla/Mozilla_Firefox_Beta/firefox/
...
Exec=/opt/Mozilla/Mozilla_Firefox_Beta/firefox/firefox %%u --class FirefoxBeta
Icon=/opt/Mozilla/Mozilla_Firefox_Beta/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Exec=/opt/Mozilla/Mozilla_Firefox_Beta/firefox/firefox --new-window %%u --class FirefoxBeta
Name=New Window
...
Exec=/opt/Mozilla/Mozilla_Firefox_Beta/firefox/firefox --private-window %%u --class FirefoxBeta
...
cp Mozilla_Firefox_Beta.desktop /usr/share/applications 2>/dev/null || true
...
find /home/*/"$DESKTOP_NAME" -maxdepth 1 -type d -exec cp Mozilla_Firefox_Beta.desktop '{}' \; -exec chown --reference='{}' '{}/Mozilla_Firefox_Beta.desktop' \;

# Adds a desktop icon to all future new login users.
mkdir -p /etc/skel/Desktop
cp Mozilla_Firefox_Beta.desktop /etc/skel/Desktop
