...
sudo mkdir /opt/firefox_nightly ;
# Extracts to install path.
sudo tar xjf FirefoxNightly.tar.bz2 -C /opt/firefox_nightly/ ;
# Required permissions needed for Mozilla Firefox automatic update feature to work.
sudo chmod -R 757 /opt/firefox_nightly/firefox/ ;
...
sudo cp Firefox_Nightly.desktop /usr/share/applications ;
...
sudo mkdir -p /etc/skel/Desktop ; sudo cp Firefox_Nightly.desktop /etc/skel/Desktop ;
