...
prompt_for_uninstallation() {
  printf "Do you want to uninstall Mozilla Firefox Extended Support Release? \n"
...
uninstall_firefox() {
  ...
  printf "Or press Enter for the default path: /opt/Mozilla_Firefox_Extended_Support_Release "
  read -r uninstall_path
  if [ -z "$uninstall_path" ]; then
    uninstall_path="/opt/Mozilla_Firefox_Extended_Support_Release"
  fi
