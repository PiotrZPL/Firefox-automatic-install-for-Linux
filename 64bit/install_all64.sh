...
# v3.0.0
#
# This script installs all 64-bit releases of Mozilla Firefox.
...
STABLE_URL="https://download.mozilla.org/?product=firefox-latest&os=linux64"
BETA_URL="https://download.mozilla.org/?product=firefox-beta-latest&os=linux64"
DEV_URL="https://download.mozilla.org/?product=firefox-devedition-latest-ssl&os=linux64"
NIGHTLY_URL="https://download.mozilla.org/?product=firefox-nightly-latest-ssl&os=linux64"
ESR_URL="https://download.mozilla.org/?product=firefox-esr-latest-ssl&os=linux64"

# Define installation directories
STABLE_INSTALL_DIR="/opt/Mozilla_Firefox"
BETA_INSTALL_DIR="/opt/Mozilla_Firefox_Beta"
DEV_INSTALL_DIR="/opt/Mozilla_Firefox_Developer_Edition"
NIGHTLY_INSTALL_DIR="/opt/Mozilla_Firefox_Nightly"
ESR_INSTALL_DIR="/opt/Mozilla_Firefox_Extended_Support"
...
create_desktop_file() {
    edition_name="$1"
    install_path="$2"
    desktop_file_name="Mozilla Firefox"
    ...
    case "$edition_name" in
        "Stable")
            ...
            ;;
        "Beta")
            desktop_file_name="Mozilla Firefox Beta"
            ;;
        "Developer")
            desktop_file_name="Mozilla Firefox Developer Edition"
            ;;
        "Nightly")
            desktop_file_name="Mozilla Firefox Nightly"
            ;;
        "ESR")
            desktop_file_name="Mozilla Firefox Extended Support Release"
            ;;
    esac
...
download_and_install "$STABLE_URL" "Stable" "$STABLE_INSTALL_DIR"
download_and_install "$BETA_URL" "Beta" "$BETA_INSTALL_DIR"
download_and_install "$DEV_URL" "Developer" "$DEV_INSTALL_DIR"
download_and_install "$NIGHTLY_URL" "Nightly" "$NIGHTLY_INSTALL_DIR"
download_and_install "$ESR_URL" "ESR" "$ESR_INSTALL_DIR"

# Print installation information using printf
printf "\n\n"
printf "Mozilla Firefox has been successfully installed in the following directories:\n"
