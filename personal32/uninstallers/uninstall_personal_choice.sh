...
# - The script is designed to target 32-bit editions of Firefox.
# - It uses several helper scripts located in the "./personal32/uninstallers/" directory for actual uninstallation.
...
display_menu() {
  ...
  printf -- '%s\n' "   Firefox automatic install for Linux" \
    ...
    " 6. Uninstall ALL personal 32-bit editions" \
...
uninstall_edition() {
  edition="$1"
  script_path="./personal32/uninstallers/un${edition}.sh"
  ...
  # Uninstall all 32-bit editions of Firefox at once.
  # Calls the appropriate script to uninstall all editions.
uninstall_all_editions() {
  clear
  printf -- '\n%s\n\n' "You selected to remove ALL 32-bit editions"
  chmod +x "./personal32/uninstallers/uninstall_all_personal32.sh"
  "./personal32/uninstallers/uninstall_all_personal32.sh"
}
...
purge_firefox() {
  ...
  if [ "$answer" = "y" ] || [ "$answer" = "Y" ]; then
    chmod +x "./personal32/uninstallers/personal_purge.sh"
    "./personal32/uninstallers/personal_purge.sh"
  else
