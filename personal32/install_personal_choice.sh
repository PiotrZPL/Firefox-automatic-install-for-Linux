#!/bin/sh
#
# Firefox automatic install for Linux - personl - 32-bit
# v3.0.0
...
install_all_editions() {
  ...
  chmod +x "${SCRIPT_DIR}/install_all_personal32.sh"
  "${SCRIPT_DIR}/install_all_personal32.sh"
}
...
display_main_menu() {
  ...
  printf -- '%s\n' "   Firefox automatic install for Linux" \
    " " \
    "           P E R S O N A L - I N S T A L L - 32-bit" \
    " " \
    " " \
    " 1. Mozilla Firefox" \
    " 2. Firefox Beta" \
