...
#
echo
chmod +x FirefoxStable.sh FirefoxBeta.sh Firefox-Developer-Edition.sh FirefoxNightly.sh
echo
 while true; do
...
onto your computer?" yn
    case $yn in
        [Yy]* ) ./FirefoxStable.sh; ./FirefoxBeta.sh; ./Firefox-Developer-Edition.sh; ./FirefoxNightly.sh; echo; echo; echo ALL editions of Mozilla Firfox have been installed; echo  They ALL will update themselves. No additional action is required.; echo; echo Happy Browsing!; echo; break;;
        [Nn]* ) exit;;
