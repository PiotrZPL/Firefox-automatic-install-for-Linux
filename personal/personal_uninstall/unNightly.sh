...
printf "Are you sure you want to uninstall Firefox Nightly? [y/N]: "
read -r confirm

if [ "$confirm" != "y" ] && [ "$confirm" != "Y" ]; then
    printf -- '%s\n' "" "" "Uninstallation canceled. Firefox Nightly has not been deleted." "" ""
    exit 0
fi
...
# Installation
rm -r -f "$HOME/Mozilla/firefox_nightly"
